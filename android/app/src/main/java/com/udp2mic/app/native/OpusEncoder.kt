...
class OpusEncoder(
    ...
    var deviceId: ByteArray = ByteArray(Udp2MicProtocol.DEVICE_ID_SIZE)
    ...
    fun encode(pcm: ShortArray): ByteArray? {
        ...
        return try {
            ...
            val packet = Udp2MicProtocol.buildPacket(
                isAudio = true,
                msgType = Udp2MicProtocol.TYPE_DATA,
    ...
    fun encodeTo(pcm: ShortArray, dest: ByteArray, offset: Int): Int {
        ...
        return try {
            ...
            val written = Udp2MicProtocol.writeAudioHeader(dest, offset, nbBytes, sampleRateId, seqNum++, deviceId, bitrateId)
            encodeCount++
            written
